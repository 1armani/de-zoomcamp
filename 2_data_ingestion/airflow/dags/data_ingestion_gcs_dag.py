...
dataset_file = dataset_file_gz.replace('.gz', '')
...
with DAG(
    ...
    download_dataset_task = BashOperator(
        ...
        #bash_command=f"curl -sSL {dataset_url} > {path_to_local_home}/{dataset_file_gz}"
        bash_command=f"wget -q {dataset_url} -O {path_to_local_home}/{dataset_file_gz}"
    )

    extract_dataset_task = BashOperator(
        task_id="extract_dataset_task",
        bash_command=f"gzip -d -f {path_to_local_home}/{dataset_file_gz}"
    )
